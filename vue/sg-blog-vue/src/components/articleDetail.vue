...
<template>
        <div class="detailBox tcommonBox" >
            <header>
                ...
                <h2>
                  <span >{{detailObj.nickName}}</span> 发表于 <span >{{detailObj.createTime}}</span> •
                ...
                <div class="card-meta">
                  ...
                  <button v-if="detailObj.nickName===userInfo.nickName" class="detele" @click="handleDelete">删除</button>
                </div>
            </header>
        ...
        message: '已取消删除'
            ...
            getArticleDetail:function(){
                getArticle(this.aid).then((response)=>{
                    ...
                    console.log("这是detailobj",this.detailObj);
