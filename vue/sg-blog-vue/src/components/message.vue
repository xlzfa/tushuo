    ...
    <div class="tmsgBox"  ref="tmsgBox">
            ...
            <form class=""  >
                ...
                <el-row class="tmsg-r-info">
                    <el-col :span="24" class="info-submit">
                        <el-button type="primary" style="width: 100%;" @click="sendMsg">{{ sendTip }}</el-button>
        ...
        <div class="tmsg-comments"  ref="listDom">
            ...
            <div class="tmsg-commentshow">
                ...
                <el-button v-show="hasMore" type="primary" style="width: 100%;" @click="addMoreFun">查看更多</el-button>
                <el-button v-show="!hasMore" type="primary" style="width: 100%;">没有更多</el-button>
            </div>
        </div>
    </div>
</template>
