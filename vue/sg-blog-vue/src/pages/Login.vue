        ...
        <div class="container">
            ...
            <div v-show="!err2005" class="">
                <div v-if="login==1" class="loginBox">
                    ...
                    <h3><a href="">忘记密码？</a></h3>
                    <el-button type="primary" style="width: 100%;" @click="gotoHome">登录</el-button>
                ...
                <div v-else class="registerBox">
                    ...
                    <el-button type="primary" style="width: 100%;"  @click="newRegister" v-loading.fullscreen.lock="fullscreenLoading"  element-loading-text="提交中">注册</el-button>
                </div>
            </div>
        </div>
    </div>
